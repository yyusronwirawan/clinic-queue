...
<!-- Additional Menus -->
<li class="menu-item {{ Request::is('admin/fisioterapis*') ? 'active' : '' }}">
  <a class="menu-link cursor-pointer" onclick="window.location.href='/admin/fisioterapis'">
    <i class="menu-icon tf-icons bx bx-user"></i>
    <div>Data Fisioterapis</div>
  </a>
</li>
<li class="menu-item {{ Request::is('admin/jadwal-dokter*') ? 'active' : '' }}">
  <a class="menu-link cursor-pointer" onclick="window.location.href='/admin/jadwal-dokter'">
    <i class="menu-icon tf-icons bx bx-calendar"></i>
    <div>Jadwal Fisioterapis</div>
  </a>
</li>
