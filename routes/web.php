...
use App\Http\Controllers\AdminFisioterapisController;
...
// fisioterapis data
Route::get('/admin/fisioterapis', [AdminFisioterapisController::class, 'index'])->middleware('admin');
Route::get('/admin/fisioterapis/filter', [AdminFisioterapisController::class, 'filter'])->middleware('admin');
Route::post('/admin/fisioterapis/delete', [AdminFisioterapisController::class, 'deleteFisioterapis'])->middleware('admin');
Route::get('/admin/fisioterapis/delete', function () {
    return redirect('/admin/fisioterapis');
})->middleware('admin');
Route::post('/admin/fisioterapis/edit', [AdminFisioterapisController::class, 'editFisioterapis'])->middleware('admin');
Route::get('/admin/fisioterapis/edit', function () {
    return redirect('/admin/fisioterapis');
})->middleware('admin');
// Menambahkan nama rute di sini
Route::get('/admin/fisioterapis/search', [AdminFisioterapisController::class, 'search'])->name('fisioterapis.search')->middleware('admin');
